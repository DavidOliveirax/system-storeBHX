<template class>
    <div class="flex">
        <div class="flex justify-between">
            <div class="flex h-screen flex-col justify-between border-e bg-gray-800">
                <div class="px-4 py-6">
                    <a href="#">
                        <img @click="showBemVindo" class="flex place-content-center rounded-lg" src="/assets/image/logo-ddm.png" alt="Logo DDM">
                    </a>
...
<script setup>
const currentComponent = ref('bemVindo')
const showCPF = () => {
    currentComponent.value = 'ClientesP';
};
